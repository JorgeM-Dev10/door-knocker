    ...
    <div className="h-full">
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="bg-gradient-to-br from-sleek-black-light to-sleek-black rounded border border-border-dark/50 p-3 sm:p-4 hover:border-border-dark/70 hover:shadow-md hover:scale-[1.02] transition-all duration-300">
